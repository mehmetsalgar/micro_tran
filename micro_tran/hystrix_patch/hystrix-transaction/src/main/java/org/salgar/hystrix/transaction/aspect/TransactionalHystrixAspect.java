package org.salgar.hystrix.transaction.aspect;
...
import org.salgar.hystrix.transaction.command.factory.TransactionalHystrixCommandFactory;
...
@Aspect
public class TransactionalHystrixAspect {
    ...
    private static class CollapserMetaHolderFactory extends MetaHolderFactory {
        ...
        public MetaHolder create(Object proxy, Method collapserMethod, Object obj, Object[] args, final ProceedingJoinPoint joinPoint) {
            ...
            final TransactionalHystrixCommand transactionalHystrixCommand = batchCommandMethod.getAnnotation(TransactionalHystrixCommand.class);
            if (transactionalHystrixCommand == null) {
                throw new IllegalStateException("batch method must be annotated with HystrixCommand annotation");
            }
            
            HystrixCommand hystrixCommand = convertTransactionalHystrixCommand2HystrixCommand(transactionalHystrixCommand);
    ...
    private static class CommandMetaHolderFactory extends MetaHolderFactory {
        ...
        public MetaHolder create(Object proxy, Method method, Object obj, Object[] args, final ProceedingJoinPoint joinPoint) {
        	TransactionalHystrixCommand transactionalHystrixCommand = method.getAnnotation(TransactionalHystrixCommand.class);
        	HystrixCommand hystrixCommand = convertTransactionalHystrixCommand2HystrixCommand(transactionalHystrixCommand);
    ...
    private enum HystrixPointcutType {
        ...
        static HystrixPointcutType of(Method method) {
            return method.isAnnotationPresent(TransactionalHystrixCommand.class) ? COMMAND : COLLAPSER;
        }
    }
    ...
    private static HystrixCommand convertTransactionalHystrixCommand2HystrixCommand(final TransactionalHystrixCommand transactionalHystrixCommand) {
    	HystrixCommand hystrixCommand = new HystrixCommand() {
			...
			public String groupKey() {
				return transactionalHystrixCommand.groupKey();
			}

			@Override
			public String commandKey() {
				return transactionalHystrixCommand.commandKey();
			}

			@Override
			public String threadPoolKey() {
				return transactionalHystrixCommand.threadPoolKey();
			}

			@Override
			public String fallbackMethod() {
				return transactionalHystrixCommand.fallbackMethod();
			}

			@Override
			public HystrixProperty[] commandProperties() {
				return transactionalHystrixCommand.commandProperties();
			}

			@Override
			public HystrixProperty[] threadPoolProperties() {
				return transactionalHystrixCommand.threadPoolProperties();
			}

			@Override
			public Class<? extends Throwable>[] ignoreExceptions() {
				return transactionalHystrixCommand.ignoreExceptions();
			}

			@Override
			public ObservableExecutionMode observableExecutionMode() {
				return transactionalHystrixCommand.observableExecutionMode();
			}
        };
