...
package org.salgar.eureka.config;
...
public class CompositeEurekaDiscoverClientConfiguration implements SmartLifecycle, Ordered {
	private static final Logger log = LoggerFactory.getLogger(CompositeEurekaDiscoverClientConfiguration.class);
	...
	public CompositeEurekaDiscoverClientConfiguration() {
	...
	protected static class EurekaClientConfigurationRefresher {
		@Autowired
		private CompositeEurekaDiscoverClientConfiguration clientConfig;
